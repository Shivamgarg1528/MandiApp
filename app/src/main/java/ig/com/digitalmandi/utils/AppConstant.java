...
public class AppConstant {
    ...
    public static final String END_POINT = "http://www.studyextension.in/shivam/to/";

    /* Files Name*/
    public static final String DIRECTORY_NAME = "DIGITAL_MANDI";
    public static final String ORDER_BILL_PREFIX = "Order_#";
    public static final String PAYMENT_BILL_PREFIX = "Payment_#";
